  ...
  return (
    ...
    >
      ...
      <div ref={boxRef3} className="flex md:flex-row flex-col md:px-28 gap-3">
        {
          icons.map((i, index) => (
            <div key={index} className="bg-black/20 card-animate border-1 md:px-6 2xl:py-6 md:py-4 px-3 py-2 border-white/20 2xl:space-y-3 text-white md:space-y-1 md:w-1/3">
              <div className="flex justify-between items-center mb-1.5 md:mb-3">
                <div className="p-2 bg-white/20 rounded-full text-md 2xl:text-3xl md:text-lg">{i.icon}</div>
